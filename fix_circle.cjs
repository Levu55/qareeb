...
const userTarget = `<div className="flex-1 w-[85%] max-w-[340px] md:max-w-[400px] mx-auto md:ml-auto md:mr-4 lg:mr-8">
             <div className="relative w-full aspect-[3/4] md:aspect-square lg:aspect-[4/5] bg-[#EAF5F5] rounded-[32px] shadow-2xl overflow-hidden border-[6px] border-white transition-all duration-500 ease-out hover:shadow-3xl hover:-translate-y-2">
               <img src={heroImg} className="absolute inset-0 w-full h-full object-cover object-[70%_15%] transition-transform duration-700 ease-out hover:scale-105" alt="" />
             </div>
           </div>`;

const userReplace = `<div className="flex-1 w-[85%] max-w-[340px] md:max-w-[400px] mx-auto md:ml-auto md:mr-4 lg:mr-8 flex items-center justify-center">
             <div className="relative w-full aspect-square bg-[#EAF5F5] rounded-full shadow-2xl overflow-hidden border-[6px] border-white transition-all duration-500 ease-out hover:shadow-3xl hover:-translate-y-2">
               <img src={heroImg} className="absolute inset-0 w-full h-full object-cover object-[70%_25%] transition-transform duration-700 ease-out hover:scale-105" alt="" />
             </div>
           </div>`;
...
const authTarget = `<div className="w-full lg:w-[45%] flex items-center justify-center relative z-10 mt-8 lg:mt-0 pb-12 lg:pb-0 px-4">
