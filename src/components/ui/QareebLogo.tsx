...
export function QareebLogo({ className = "w-32 h-auto" }: { className?: string }) {
  return (
    <svg viewBox="0 0 100 120" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M50 5 C25 5, 15 30, 15 45 C15 75, 50 95, 50 95 C50 95, 85 75, 85 45 C85 30, 75 5, 50 5 Z" fill="#00C4B6" />
      ...
      <circle cx="80" cy="85" r="9" fill="#FF6B2C" />
      <text x="50" y="118" fontFamily="system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" fontSize="26" fontWeight="bold" letterSpacing="-0.05em" fill="#00C4B6" textAnchor="middle">qareeb</text>
    </svg>
  );
}
