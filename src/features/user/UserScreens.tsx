      ...
      <div className="px-6 md:px-12 lg:px-24 mb-16">
        <div className="bg-teal-50 border border-brand-teal/20 rounded-[40px] p-8 md:p-12 relative overflow-hidden flex flex-col md:flex-row items-center gap-10 shadow-sm">
           ...
           <div className="flex-1 relative z-10">
             ...
             <Button className="h-12 px-8 rounded-xl text-base bg-brand-orange text-white hover:bg-brand-orange-hover shadow-md transition-colors border-none" onClick={() => navigate('/user/become-helper')}>
               Become a Helper
             </Button>
           </div>
      ...
      <div className="bg-white rounded-t-[40px] shadow-[0_-20px_40px_rgba(0,0,0,0.08)] relative z-20 px-6 pt-8 pb-10">
        ...
        <div className="flex items-center gap-4 mb-8">
           ...
           <div className="flex gap-2">
             <button className="w-12 h-12 rounded-full bg-brand-orange/10 text-brand-orange flex items-center justify-center hover:bg-brand-orange hover:text-white transition-colors">
